...
void solve()
{
	...
	for (i = 0; i < n; i++) {
		...
		if (drop != -1 && inc == n && i < n - 1 && a[i] < a[i + 1])
			inc = i;
	}
	// cout << drop << " " << inc << endl;

	if (drop == -1 && a[n - 2] < a[n - 1]) {
		cout << "yes" << endl;
		cout << 1 << " " << 1;
	}
	else if (drop == -1 && a[n - 2] > a[n - 1]) {
		cout << "yes" << endl;
		cout << n - 1 << " " << n;
	}
	else if (drop != -1 && inc == n) {
		if (drop == 0) {
			cout << "yes" << endl;
			cout << 1 << " " << n;
		}
		else if (a[drop - 1] < a[n - 1]) {
			cout << "yes" << endl;
			cout << drop + 1 << " " << n;
		}
		else {
	...
	else if (drop != -1 && inc != n && a[n - 2] > a[n - 1]) {
		cout << "no";
		return;
	}
	else if (drop != -1 && inc != n) {
		if (drop == 0) {
			...
			if (inc == n - 1) {
				...
				if (a[inc] > a[drop - 1] && a[drop] < a[inc + 1]) {
					cout << "yes" << endl;
					cout << drop + 1 << " " << inc + 1;
				}
				else {
